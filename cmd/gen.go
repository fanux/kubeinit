...
func init() {
	...
	genCmd.Flags().StringVar(&define.KubeFlags.EtcdImage, "etcd-image", "gcr.io/google_containers/etcd-amd64:3.1.10", "etcd docker image")
	...
	genCmd.Flags().StringVar(&define.KubeFlags.Version, "version", "v1.9.0", "kubernetes version")
